...
# Stati Esteri allineati con il sito dell'agenzia delle entrate
# http://www.agenziaentrate.gov.it/wps/file/Nsilib/Nsi/Strumenti/
# Codici+attivita+e+tributo/Codici+territorio/Comuni+italia+esteri/
# Codici+Stati+esteri/ESTERI.zip

# Comuni allineati con l'elenco ISTAT aggiornato al 30/06/2014
# http://www.istat.it/it/files/2011/01/Elenco_Comuni_Italiani_al-30_06_2014.zip

from __future__ import unicode_literals
from .it_province import PROVINCE_CHOICES

#: An alphabetical list of continents
CONTINENT_CHOICES = (
    ('1', 'Europa'),
    ('2', 'Asia'),
    ('3', 'Africa'),
    ...
    ('7', 'Oceania'),
    ('8', 'Terre Polari Artiche'),
    ('9', 'Terre Polari Antartiche'),
)
...
FOREIGN_STATES = (
    ...
    ("Z101", "Andorra", "1"),
    ("Z302", "Angola", "3"),
    ("Z529", "Anguilla (Isola)", "5"),
    ("Z532", "Antigua e Barbuda", "5"),
    ("Z500", "Antille Britanniche", "5"),
    ("Z521", "Antille Britanniche", "5"),
    ("Z523", "Antille Britanniche", "5"),
    ("Z501", "Antille Olandesi", "5"),
    ("Z201", "Arabia Meridionale Federazione", "2"),
    ("Z202", "Arabia Meridionale Protettorato", "2"),
    ("Z203", "Arabia Saudita", "2"),
    ("Z600", "Argentina", "6"),
    ("Z137", "Armenia", "1"),
    ("Z252", "Armenia", "2"),
    ("Z700", "Australia", "7"),
    ...
    ("Z249", "Bangladesh", "2"),
    ("Z522", "Barbados", "5"),
    ("Z303", "Basutoland-Sud Africa Britannico", "3"),
    ("Z304", "Beciuania-Sud Africa Britannico", "3"),
    ("Z103", "Belgio", "1"),
    ("Z512", "Belize / Honduras Britannico", "5"),
    ("Z314", "Benin", "3"),
    ("Z400", "Bermuda (Isole)", "4"),
    ("Z205", "Bhutan", "2"),
    ("Z139", "Bielorussia / Russia Bianca", "1"),
    ("Z206", "Birmania", "2"),
    ("Z601", "Bolivia", "6"),
    ("Z364", "Bophuthatswana", "3"),
    ("Z153", "Bosnia ed Erzegovina", "1"),
    ("Z358", "Botswana", "3"),
    ("Z602", "Brasile", "6"),
    ("Z207", "Brunei", "2"),
    ("Z104", "Bulgaria", "1"),
    ...
    ("Z306", "Camerun", "3"),
    ("Z401", "Canada", "4"),
    ("Z307", "Capo Verde (Isole)", "3"),
    ("Z701", "Caroline (Isole) / Stati Federati di Micronesia", "7"),
    ("Z530", "Cayman (Isole)", "5"),
    ("Z156", "Ceca Repubblica", "1"),
    ("Z105", "Cecoslovacchia", "1"),
    ("Z308", "Centrafricana Repubblica", "3"),
    ("Z702", "Christmas (Isola)", "7"),
    ("Z309", "Ciad", "3"),
    ("Z603", "Cile", "6"),
    ("Z210", "Cina Repubblica Popolare", "2"),
    ("Z211", "Cipro", "2"),
    ("Z367", "Ciskei", "3"),
    ("Z106", "Citta' del Vaticano", "1"),
    ("Z212", "Cocos (Isole)", "2"),
    ("Z604", "Colombia", "6"),
    ("Z310", "Comore (Isole)", "3"),
    ("Z370", "Congo Belga", "3"),
    ("Z311", "Congo Repubblica Popolare", "3"),
    ("Z703", "Cook (Isole)", "7"),
    ("Z214", "Corea del Nord", "2"),
    ("Z213", "Corea del Sud", "2"),
    ("Z313", "Costa D'avorio", "3"),
    ("Z503", "Costa Rica", "5"),
    ("Z149", "Croazia", "1"),
    ("Z504", "Cuba", "5"),
    ("Z107", "Danimarca", "1"),
    ("Z900", "Dipendenze Australiane", "9"),
    ("Z901", "Dipendenze Britanniche", "9"),
    ("Z800", "Dipendenze Canadesi", "8"),
    ("Z902", "Dipendenze Francesi", "9"),
    ("Z903", "Dipendenze Neozelandesi", "9"),
    ("Z904", "Dipendenze Norvegesi Antartiche", "9"),
    ("Z801", "Dipendenze Norvegesi Artiche", "8"),
    ("Z802", "Dipendenze Russe", "8"),
    ("Z905", "Dipendenze Statunitensi", "9"),
    ("Z906", "Dipendenze Sudafricane", "9"),
    ("Z526", "Dominica", "5"),
    ("Z505", "Dominicana Repubblica", "5"),
    ("Z605", "Ecuador", "6"),
    ("Z336", "Egitto", "3"),
    ("Z506", "El Salvador", "5"),
    ("Z215", "Emirati Arabi Uniti", "2"),
    ("Z368", "Eritrea", "3"),
    ("Z144", "Estonia", "1"),
    ("Z315", "Etiopia", "3"),
    ("Z108", "Faer Oer (Isole)", "1"),
    ("Z704", "Figi / Viti (Isole)", "7"),
    ("Z216", "Filippine", "2"),
    ("Z109", "Finlandia", "1"),
    ("Z110", "Francia", "1"),
    ("Z316", "Gabon", "3"),
    ("Z317", "Gambia", "3"),
    ("Z218", "Gaza (Territorio di)", "2"),
    ("Z136", "Georgia", "1"),
    ("Z254", "Georgia", "2"),
    ("Z112", "Germania", "1"),
    ("Z111", "Germania Repubblica Democratica", "1"),
    ("Z318", "Ghana", "3"),
    ("Z507", "Giamaica", "5"),
    ("Z219", "Giappone", "2"),
    ("Z113", "Gibilterra", "1"),
    ("Z361", "Gibuti", "3"),
    ("Z705", "Gilbert e Ellice (Isole)", "7"),
    ("Z220", "Giordania", "2"),
    ("Z114", "Gran Bretagna e Irlanda del Nord", "1"),
    ("Z115", "Grecia", "1"),
    ("Z524", "Grenada", "5"),
    ("Z402", "Groenlandia", "4"),
    ("Z508", "Guadalupa", "5"),
    ("Z706", "Guam (Isola)", "7"),
    ("Z509", "Guatemala", "5"),
    ("Z607", "Guayana   Guiana Francese", "6"),
    ("Z608", "Guayana Olandese", "6"),
    ("Z319", "Guinea", "3"),
    ("Z320", "Guinea Bissau", "3"),
    ("Z321", "Guinea Equatoriale", "3"),
    ("Z606", "Guyana Britannica", "6"),
    ("Z510", "Haiti", "5"),
    ("Z511", "Honduras", "5"),
    ("Z221", "Hong Kong", "2"),
    ("Z323", "Ifni", "3"),
    ...
    ("Z325", "Liberia", "3"),
    ("Z326", "Libia", "3"),
    ("Z119", "Liechtenstein", "1"),
    ("Z146", "Lituania", "1"),
    ("Z120", "Lussemburgo", "1"),
    ("Z231", "Macao", "2"),
    ("Z148", "Macedonia", "1"),
    ("Z708", "Macquarie (Isole)", "7"),
    ("Z327", "Madagascar", "3"),
    ("Z328", "Malawi", "3"),
    ("Z230", "Malaysia", "2"),
    ("Z247", "Malaysia", "2"),
    ...
    ("Z329", "Mali", "3"),
    ("Z121", "Malta", "1"),
    ("Z609", "Malvine / Falkland (Isole)", "6"),
    ("Z122", "Man (Isola)", "1"),
    ("Z709", "Marcus (Isole)", "7"),
    ("Z710", "Marianne (Isole)", "7"),
    ("Z330", "Marocco", "3"),
    ("Z711", "Marshall (Isole)", "7"),
    ("Z513", "Martinica", "5"),
    ("Z331", "Mauritania", "3"),
    ("Z332", "Maurizio (Isole)", "3"),
    ("Z360", "Mayotte (Isola)", "3"),
    ("Z514", "Messico", "5"),
    ("Z735", "Micronesia Stati Federati", "7"),
    ("Z712", "Midway (Isole)", "7"),
    ("Z140", "Moldavia", "1"),
    ("Z123", "Monaco", "1"),
    ("Z233", "Mongolia", "2"),
    ...
    ("Z531", "Montserrat", "5"),
    ("Z333", "Mozambico", "3"),
    ("Z300", "Namibia / Africa del Sud Ovest", "3"),
    ("Z713", "Nauru (Isole)", "7"),
    ("Z234", "Nepal", "2"),
    ("Z515", "Nicaragua", "5"),
    ("Z334", "Niger", "3"),
    ("Z335", "Nigeria", "3"),
    ("Z714", "Niue / Savage (Isole)", "7"),
    ("Z715", "Norfolk (Isole e Isole del Mar dei Coralli)", "7"),
    ("Z124", "Normanne (Isole) / Isole del Canale", "1"),
    ("Z125", "Norvegia", "1"),
    ("Z716", "Nuova Caledonia (Isole e Dipendenze)", "7"),
    ("Z718", "Nuova Guinea", "7"),
    ("Z719", "Nuova Zelanda", "7"),
    ("Z717", "Nuove Ebridi (Isole Condominio Franco-Inglese)", "7"),
    ("Z369", "Nyasaland", "3"),
    ("Z235", "Oman", "2"),
    ("Z126", "Paesi Bassi", "1"),
    ("Z236", "Pakistan", "2"),
    ("Z734", "Palau Repubblica", "7"),
    ("Z517", "Panama Zona del Canale", "5"),
    ("Z516", "Panama'", "5"),
    ("Z730", "Papua Nuova Guinea", "7"),
    ("Z720", "Papuasia", "7"),
    ("Z610", "Paraguay", "6"),
    ("Z721", "Pasqua (Isola)", "7"),
    ("Z611", "Peru'", "6"),
    ("Z722", "Pitcairn (e Dipendenze)", "7"),
    ("Z723", "Polinesia Francese (Isole)", "7"),
    ("Z127", "Polonia", "1"),
    ("Z128", "Portogallo", "1"),
    ("Z518", "Puerto Rico", "5"),
    ("Z237", "Qatar", "2"),
    ("Z129", "Romania", "1"),
    ("Z338", "Ruanda", "3"),
    ("Z154", "Russia / Federazione Russa", "1"),
    ("Z238", "Ryukyu (Isole)", "2"),
    ("Z362", "Sahara Meridionale", "3"),
    ("Z363", "Sahara Settentrionale", "3"),
    ("Z339", "Sahara Spagnolo", "3"),
    ("Z533", "Saint Kitts e Nevis / Saint Christopher e Nevis", "5"),
    ("Z527", "Saint Lucia", "5"),
    ("Z403", "Saint Pierre Et Miquelon (Isole)", "4"),
    ("Z528", "Saint Vincent e Grenadine", "5"),
    ("Z724", "Salomone (Isole)", "7"),
    ("Z726", "Samoa", "7"),
    ("Z725", "Samoa Americane (Isole)", "7"),
    ("Z130", "San Marino", "1"),
    ("Z340", "Sant'elena (Isola)", "3"),
    ("Z341", "Sao Tome' e Principe (Isole)", "3"),
    ("Z342", "Seicelle (Isole)", "3"),
    ("Z343", "Senegal", "3"),
    ("Z158", "Serbia", "1"),
    ("Z157", "Serbia e Montenegro", "1"),
    ("Z344", "Sierra Leone", "3"),
    ("Z239", "Sikkim", "2"),
    ("Z248", "Singapore", "2"),
    ("Z240", "Siria", "2"),
    ...
    ("Z150", "Slovenia", "1"),
    ("Z345", "Somalia", "3"),
    ("Z346", "Somalia Francese", "3"),
    ("Z131", "Spagna", "1"),
    ("Z209", "Sri Lanka", "2"),
    ("Z404", "Stati Uniti D'america", "4"),
    ("Z907", "Sud Sudan", "3"),
    ("Z347", "Sudafricana Repubblica", "3"),
    ("Z348", "Sudan", "3"),
    ("Z132", "Svezia", "1"),
    ("Z133", "Svizzera", "1"),
    ("Z349", "Swaziland-Sudafrica Britannico", "3"),
    ("Z147", "Tagikistan", "1"),
    ("Z257", "Tagikistan", "2"),
    ("Z217", "Taiwan", "2"),
    ("Z350", "Tanganica", "3"),
    ("Z357", "Tanzania", "3"),
    ("Z161", "Territori Palestinesi", "1"),
    ("Z241", "Thailandia", "2"),
    ("Z242", "Timor (Isola)", "2"),
    ("Z351", "Togo", "3"),
    ("Z727", "Tokelau / Isole dell'Unione", "7"),
    ("Z728", "Tonga / Isole degli Amici", "7"),
    ("Z365", "Transkei", "3"),
    ("Z612", "Trinidad e Tobago", "6"),
    ("Z352", "Tunisia", "3"),
    ("Z243", "Turchia", "2"),
    ("Z151", "Turkemenistan", "1"),
    ("Z258", "Turkemenistan", "2"),
    ("Z519", "Turks e Caicos (Isole)", "5"),
    ("Z732", "Tuvalu", "7"),
    ("Z138", "Ucraina", "1"),
    ("Z353", "Uganda", "3"),
    ("Z134", "Ungheria", "1"),
    ("Z135", "Unione Repubbliche Socialiste Sovietiche", "1"),
    ("Z613", "Uruguay", "6"),
    ("Z143", "Uzbekistan", "1"),
    ("Z259", "Uzbekistan", "2"),
    ("Z733", "Vanuatu", "7"),
    ("Z366", "Venda", "3"),
    ("Z614", "Venezuela", "6"),
    ("Z520", "Vergini Americane (Isole)", "5"),
    ("Z525", "Vergini Britanniche (Isole)", "5"),
    ("Z251", "Vietnam", "2"),
    ("Z245", "Vietnam del Nord", "2"),
    ("Z244", "Vietnam del Sud", "2"),
    ("Z729", "Wallis e Futuna (Isole)", "7"),
    ("Z246", "Yemen", "2"),
    ("Z250", "Yemen Repubblica Democratica Popolare", "2"),
    ("Z312", "Zaire / Congo Repubblica Democratica", "3"),
    ("Z355", "Zambia", "3"),
    ("Z356", "Zanzibar", "3"),
    ("Z337", "Zimbabwe", "3"),
)
...
COMUNI = (
    ...
    ("L426", "Trigolo", "CR"),
    ("L427", "Trinità", "CN"),
    ("L428", "Trinità d'Agultu e Vignola", "OT"),
    ("B915", "Trinitapoli", "BT"),
    ("L429", "Trino", "VC"),
    ("L430", "Triora", "IM"),
    ("L431", "Tripi", "ME"),
...
#: A dictionary of states mapped to continents
CONTINENT_STATES = {}
for continent, _ in CONTINENT_CHOICES:
    CONTINENT_STATES[continent] = sorted([p[0] for p in FOREIGN_STATES if p[2] == continent])

#: A alphabetical list of states mapped to continents
CONTINENT_STATES_CHOICES = []
for continent, continent_name in CONTINENT_CHOICES:
    CONTINENT_STATES_CHOICES.append((continent_name.upper(), () + tuple((p[0], p[1]) for p in FOREIGN_STATES if p[2] == continent)))

#: A dictionary of comuni mapped to provincie
PROVINCE_COMUNI = {}
for provincia, _ in PROVINCE_CHOICES:
    PROVINCE_COMUNI[provincia] = sorted([p[0] for p in COMUNI if p[2] == provincia])

#: A alphabetical list of comuni mapped to provincie
PROVINCE_COMUNI_CHOICES = []
for provincia, provincia_name in PROVINCE_CHOICES:
    PROVINCE_COMUNI_CHOICES.append((provincia_name.upper(), () + tuple((p[0], p[1]) for p in COMUNI if p[2] == provincia)))

CODICI_CHOICES = [(None, '---- Luogo non catalogato ----'),] + PROVINCE_COMUNI_CHOICES + CONTINENT_STATES_CHOICES
